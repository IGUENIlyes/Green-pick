    ...
    <>
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <h1 id="sps">
            <span id="gpk">GreenPick</span>: Bon Pour Vous, Bon Pour La Planète
          </h1>
          <p id="zez">
            <b>
      ...
      <section className="why-choose">
        ...
        <div className="benefits">
          ...
          <div className="benefit-card">
            ...
            <h3>Circuit Court</h3>
            <p>
              Nous privilégions les producteurs locaux pour réduire l'empreinte
              carbone et soutenir l'économie locale.
            </p>
          </div>
          <div className="benefit-card">
            <div className="benefit-icon">
      ...
      <section className="testimonials">
        ...
        <div className="testimonial-cards">
          ...
          <div className="testimonial-card">
            <p>
              "J'aime l'idée de savoir d'où viennent mes aliments et de soutenir
              les producteurs locaux. GreenPick rend cela si facile."
            </p>
            <div className="testimonial-author">- Jean-Pierre M.</div>
          </div>
          <div className="testimonial-card">
            <p>
              "Non seulement les produits sont excellents, mais j'apprécie aussi
              l'engagement environnemental. Un grand bravo à l'équipe!"
            </p>
